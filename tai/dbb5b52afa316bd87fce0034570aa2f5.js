...
function aicpCookieCheck(ccook,limit,delay){if(ccook!=""){if(parseInt(ccook)>=limit){aicpHideAds()}else{aicpServeAds(delay)}}else{aicpServeAds(delay)}}
function aicpHideAds(){jQuery("#adtrack.adsbygoogle").each(function(){jQuery(this).hide()})}
function aicpServeAds(delay){setTimeout(function(){jQuery("#adtrack.adsbygoogle").each(function(){(adsbygoogle=window.adsbygoogle||[]).push({})})},delay)}
